...
/* @var $searchModel app\modules\office\models\search\OfficeAccountingSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('rus', 'Транзакции общего счета');
        ...
        <div class="page-header-toolbar">
            <div class="sort-wrapper">
                <div class="btn-group toolbar-item" role="group" aria-label="">
                    <?= $this->render('../_form_create_btn', ['label' => Yii::t('rus', 'Добавить транзакцию общего счета')])?>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <div class="office-accounting-index">
                    ...
                    <?php Pjax::begin(); ?>
                        ...
                        'columns' => [
                            ...
                            [
                                'attribute' => 'type',
                                'value' => function($model){ /** @var OfficeAccounting $model */ return $model->typeLabel; },
