...
use app\modules\office\models\search\OfficeConsultationSearch;
...
class OfficeConsultationController extends Controller
{
    ...
    {
        $searchModel = new OfficeConsultationSearch();
    ...
    {
        $model = new OfficeConsultation(['account_id' => $account_id]);
