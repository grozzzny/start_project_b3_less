...
/* @var $searchModel app\modules\office\models\search\OfficeClientsSearch */
        ...
        <div class="page-header-toolbar">
            <div class="sort-wrapper">
                <div class="btn-group toolbar-item" role="group" aria-label="">
                    <?= $this->render('../_form_create_btn', ['label' => Yii::t('rus', 'Добавить клиента')])?>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <div class="office-clients-index">
