...
/* @var $searchModel app\modules\office\models\search\OfficeConsultationSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('rus', 'Консультации');
        ...
        <div class="page-header-toolbar">
            <div class="sort-wrapper">
                <div class="btn-group toolbar-item" role="group" aria-label="">
                    <?= $this->render('../_form_create_btn', ['label' => Yii::t('rus', 'Добавить консультацию')])?>
                </div>
            </div>
        </div>
    </div>
