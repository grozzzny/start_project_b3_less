...
/* @var $searchModel app\modules\office\models\search\OfficeDocumentsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('rus', 'Документы');
        ...
        <div class="page-header-toolbar">
            <div class="sort-wrapper">
                <div class="btn-group toolbar-item" role="group" aria-label="">
                    <?= $this->render('../_form_create_btn', ['label' => Yii::t('rus', 'Добавить документ')])?>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <div class="office-documents-index">
        ...
        'columns' => [
                            ...
                            [
                                'attribute' => 'client_id',
                                'value' => function($model){ /** @var OfficeDocuments $model */ return $model->client->full_name; },
                                'filter' => OfficeClients::select2Filter($searchModel)
                            ],
                            [
                                'attribute' => 'case_id',
                                'value' => function($model){ /** @var OfficeDocuments $model */ return $model->case->name; },
                                'filter' => OfficeCase::select2Filter($searchModel)
                            ],
                            [
                                'attribute' => 'consultation_id',
                                'value' => function($model){ /** @var OfficeDocuments $model */ return $model->consultation->name; },
                                'filter' => OfficeConsultation::select2Filter($searchModel)
                            ],
                            'name',
                            [
                                'attribute' => 'category',
                                'value' => function($model){ /** @var OfficeDocuments $model */ return $model->categoryLabel; },
                                'filter' => OfficeDocuments::categories()
                            ],
                            [
